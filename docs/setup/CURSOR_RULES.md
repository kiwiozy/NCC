...
## 🎯 **Project Rules** (Add to "Project Rules" section)
...
## 👤 **User Rules** (Add to "User Rules" section)
...
## 🚀 **Project Commands** (Add to "Project Commands" section)
...
## 💡 **User Commands** (Optional - Add to "User Commands" section)

These are personal commands you can use frequently:
...
### Command 4: Integration Safety Check

```
I'm about to modify integration code. Check:
1. Is this a protected integration? (Gmail, Xero, SMS, S3, AI)
2. What tests should I run?
3. What other files might be affected?
4. Should I create a new file instead?
```
...
1. Click on **"Project Rules"** section
2. Click **"Add Rule"** or **"+ Add Rule"**
3. Paste the entire "Project Rules" block above
4. Click **"Save"**

### **Step 3: Add User Rules**
1. Click on **"User Rules"** section
2. Paste the entire "User Rules" block above
3. Click **"Save"**

### **Step 4: Add Project Commands**
1. Click on **"Project Commands"** section
2. Click **"+ Add Command"**
3. For each command above:
   - Click **"Add Command"**
   - Paste the command text
   - Give it a name (e.g., "Check Protected Files")
   - Click **"Save"**

### **Step 5: Add User Commands (Optional)**
1. Click on **"User Commands"** section
2. Click **"+ Add Command"**
3. For each command above:
   - Click **"Add Command"**
   - Paste the command text
   - Give it a name (e.g., "Safe Modify")
   - Click **"Save"**
...
1. **Ask Cursor**: "Can you modify the Gmail integration?"
   - Should warn you it's protected

2. **Ask Cursor**: "Add a new patient search feature"
   - Should suggest creating new files

3. **Ask Cursor**: "Fix the email system"
   - Should ask for specific file paths

---

## 🔄 **Updating Rules**

As your project grows, update these rules:
- Add new protected files to Project Rules
- Update file paths if you reorganize
...
**Status:** Ready to use  
**Files Referenced:** `.cursorignore`, `docs/setup/CODE_ORGANIZATION_STRATEGY.md`
