...
def main():
    ...
    print()
    print("=" * 80)
    print("🔍 Finding and processing unexported documents...")
    print("=" * 80)
    
    # Process in batches (don't load all into memory first)
    ...
    while True:
        ...
        if offset == 1:
            # First batch - show total
            stats['total_found'] = found_count
            print(f"   📊 Total unexported documents: {found_count}")
        
        print(f"   📄 Processing {returned_count} documents in this batch...")
        ...
        for i, record in enumerate(records, 1):
            ...
            print(f"\n[{total_processed}/{stats['total_found']}]", end=' ')
        ...
        print(f"   Total processed so far: {total_processed}/{stats['total_found']}")
