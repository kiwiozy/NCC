...
export default function SMSTemplateManager() {
  ...
  const rows = templates.map((template) => (
    <Table.Tr key={template.id}>
      ...
      <Table.Td style={{ width: '12%', whiteSpace: 'nowrap' }}>
        <Badge color={template.is_active ? 'green' : 'gray'} variant="light">
          {template.is_active ? 'Active' : 'Inactive'}
        </Badge>
      </Table.Td>
      <Table.Td style={{ width: '18%', whiteSpace: 'nowrap' }}>
            ...
            <Table>
              <Table.Thead>
                <Table.Tr>
                  ...
                  <Table.Th style={{ width: '12%', whiteSpace: 'nowrap' }}>Status</Table.Th>
                  <Table.Th style={{ width: '18%', whiteSpace: 'nowrap' }}>Actions</Table.Th>
                </Table.Tr>
              </Table.Thead>
