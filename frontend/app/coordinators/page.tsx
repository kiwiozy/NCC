                  ...
                  <Stack gap="lg">
                    ...
                    {selectedCoordinator.contact_json && (
                      <Paper p="xl" shadow="xs">
                        ...
                        <Stack gap="md">
                          {selectedCoordinator.contact_json.phone && (
                            <Group gap="sm">
                              <IconPhone size={20} color={isDark ? '#909296' : '#495057'} />
                              <div>
                                <Text size="sm" c="dimmed">Phone</Text>
                                <Text size="md">{selectedCoordinator.contact_json.phone}</Text>
                              </div>
                            </Group>
                          )}
                          {selectedCoordinator.contact_json.mobile && (
                            <Group gap="sm">
                              <IconPhone size={20} color={isDark ? '#909296' : '#495057'} />
                              <div>
                                <Text size="sm" c="dimmed">Mobile</Text>
                                <Text size="md">{selectedCoordinator.contact_json.mobile}</Text>
                              </div>
                            </Group>
                          )}
                          {selectedCoordinator.contact_json.email && (
                            <Group gap="sm">
                              <IconMail size={20} color={isDark ? '#909296' : '#495057'} />
                              <div>
                                <Text size="sm" c="dimmed">Email</Text>
                                <Text size="md">{selectedCoordinator.contact_json.email}</Text>
                              </div>
                            </Group>
                          )}
                        </Stack>
